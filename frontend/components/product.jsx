...
export default function Product() {    
    return (
        <div className="product-root">
            <div className="logo-div-firstColumn">
                <input type="checkbox" />
            </div>

            <div className="logo-div-secondRow">
                <h4 className="logo-div-Header">Product ID</h4>
            </div>

            <div className="logo-div-thirdRow">
                <h4 className="logo-div-Header">
                    Category
                    <svg
                        width="20"
                        height="20"
            ...
            <div className="logo-div-fourthRow">
                <h4 className="logo-div-Header">Product Name</h4>
            </div>

            <div className="logo-div-fifthRow">
                <h4 className="logo-div-Header">Price</h4>
            </div>

            <div className="logo-div-sixthRow">
                <h4 className="logo-div-Header">Stock</h4>
            </div>
            
            <div className="logo-div-search">
                <h4 className="logo-div-searchHeader">Search</h4>
            </div>
        </div>
    );
};